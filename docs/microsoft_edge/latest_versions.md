...
<span class="extra-small">_Last Updated: <code style="color : mediumseagreen">July 31, 2025 02:04 PM EDT</code> [**_Raw XML_**](https://github.com/cocopuff2u/BOFA/blob/main/latest_edge_files/edge_latest_versions.xml) [**_Raw YAML_**](https://github.com/cocopuff2u/BOFA/blob/main/latest_edge_files/edge_latest_versions.yaml) [**_Raw JSON_**](https://github.com/cocopuff2u/BOFA/blob/main/latest_edge_files/edge_latest_versions.json) (Automatically Updated every hour)_</span>
...
| **Edge** <sup>Canary</sup> <br><br>Last Update:<br>`July 31, 2025` | `140.0.3469.0` | `com.microsoft.edgemac.canary` | <a href="https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/4a5a96d5-036d-492f-a510-3fa8f5b5e085/MicrosoftEdgeCanary-140.0.3469.0.pkg"><img src="/images/edge_canary.png" alt="Download Edge Canary" width="80"></a> |
