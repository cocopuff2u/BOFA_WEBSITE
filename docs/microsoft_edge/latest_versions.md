...
<span class="extra-small">_Last Updated: <code style="color : mediumseagreen">June 05, 2025 11:03 AM EDT</code> [**_Raw XML_**](https://github.com/cocopuff2u/BOFA/blob/main/latest_edge_files/edge_latest_versions.xml) [**_Raw YAML_**](https://github.com/cocopuff2u/BOFA/blob/main/latest_edge_files/edge_latest_versions.yaml) [**_Raw JSON_**](https://github.com/cocopuff2u/BOFA/blob/main/latest_edge_files/edge_latest_versions.json) (Automatically Updated every hour)_</span>
...
| **Edge** <sup>Canary</sup> <br><br>Last Update:<br>`June 05, 2025` | `139.0.3363.0` | `com.microsoft.edgemac.canary` | <a href="https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/9d2aa5fa-0097-4adb-8538-a9326623c2c2/MicrosoftEdgeCanary-139.0.3363.0.pkg"><img src="/images/edge_canary.png" alt="Download Edge Canary" width="80"></a> |
