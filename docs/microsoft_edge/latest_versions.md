...
<span class="extra-small">_Last Updated: <code style="color : mediumseagreen">July 15, 2025 04:04 AM EDT</code> [**_Raw XML_**](https://github.com/cocopuff2u/BOFA/blob/main/latest_edge_files/edge_latest_versions.xml) [**_Raw YAML_**](https://github.com/cocopuff2u/BOFA/blob/main/latest_edge_files/edge_latest_versions.yaml) [**_Raw JSON_**](https://github.com/cocopuff2u/BOFA/blob/main/latest_edge_files/edge_latest_versions.json) (Automatically Updated every hour)_</span>
...
| **Edge** <sup>Canary</sup> <br><br>Last Update:<br>`July 15, 2025` | `140.0.3436.0` | `com.microsoft.edgemac.canary` | <a href="https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/7a12494f-d242-4ba6-ae30-bc5271986980/MicrosoftEdgeCanary-140.0.3436.0.pkg"><img src="/images/edge_canary.png" alt="Download Edge Canary" width="80"></a> |
