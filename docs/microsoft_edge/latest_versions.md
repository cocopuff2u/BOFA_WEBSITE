...
<span class="extra-small">_Last Updated: <code style="color : mediumseagreen">June 30, 2025 10:03 AM EDT</code> [**_Raw XML_**](https://github.com/cocopuff2u/BOFA/blob/main/latest_edge_files/edge_latest_versions.xml) [**_Raw YAML_**](https://github.com/cocopuff2u/BOFA/blob/main/latest_edge_files/edge_latest_versions.yaml) [**_Raw JSON_**](https://github.com/cocopuff2u/BOFA/blob/main/latest_edge_files/edge_latest_versions.json) (Automatically Updated every hour)_</span>
...
| **Edge** <sup>Canary</sup> <br><br>Last Update:<br>`June 30, 2025` | `140.0.3407.0` | `com.microsoft.edgemac.canary` | <a href="https://msedge.sf.dl.delivery.mp.microsoft.com/filestreamingservice/files/0bd1c398-5d75-4e05-859f-577efa6effb1/MicrosoftEdgeCanary-140.0.3407.0.pkg"><img src="/images/edge_canary.png" alt="Download Edge Canary" width="80"></a> |
